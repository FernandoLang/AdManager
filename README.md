...
OBS: No projeto já vai ter uma migration pronta então bastará apenas executar a ultima etapa 'update-database' sem as aspas, mas caso seja necessário criar uma nova basta seguir os passos
